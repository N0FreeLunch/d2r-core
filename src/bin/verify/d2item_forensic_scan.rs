...
fn main() -> io::Result<()> {
    ...
    println!("[ForensicScan] File: {} | Range: {}..{}", path, start_bit, end_bit);
    ...
    for bit_pos in (start_bit..=end_bit).step_by(8) {
        ...
        if m1 == 0x4A && m2 == 0x4D { // 'JM'
            ...
            if is_alpha {
                ...
                print!("  [Match] at {}: ver={}, mode={}, loc={}, gap={:#04x}", 
                ...
                println!("  [Match] at {}: ver={}, mode={}, loc={} (Modern)", bit_pos, version, mode, loc);
            }
        }
    }
