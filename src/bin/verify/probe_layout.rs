...
fn main() {
    ...
    println!("--- Alpha v105 List 1 Combinatorial Probe (Start={}, TargetL2={}) ---", start_bit, target_list2);
        ...
        for val_bits in 1..=32 {
            ...
            for num_stats in 1..=10 {
                ...
                if start_bit + total_bits == target_list2 {
                    println!("MATCH FOUND: Entry={} bits (ID={} + VAL={}), Stats={}", entry_width, id_bits, val_bits, num_stats);
                }
            }
        }
    }
